...
class Private {
    ...
    v1Request({
        ...
        return KlaviyoRequest._request({ path: path, method: method, headers: headers });
    }
    ...
    v2Request({
        ...
        return KlaviyoRequest._request({ path: path, method: method, body: data, headers: headers });
    }
